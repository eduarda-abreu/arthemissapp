...
class DirTeste extends StatelessWidget {
  const DirTeste({super.key});
  ...
  Widget _buildLayoutLargo(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Image.network(
            'https://dev-arthemiss.pantheonsite.io/wp-content/uploads/2025/04/testes-e1745945956283.jpg',
            height: 250,
          ),
        ),
  ...
  Widget _buildConteudoTexto(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Parágrafo
        const Text(
          'No Arthemiss, além de aprender sobre sua saúde, você pode testar seus conhecimentos com quizzes interativos! Eles ajudam a fixar o conteúdo de forma leve e educativa, tornando o aprendizado ainda mais envolvente.',
